              ...
              <div className="relative">
                ...
                <div className="relative">
                  <select
                    ...
                    disabled={processing || !uploadedFile}
                    className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 appearance-none cursor-pointer"
